...
header('Content-Type: text/html; charset=utf-8');  
 ...
 class Crud{   
   ...
   */   
   private function __construct($conexao, $tabela=NULL){   
     ...
     if (!empty($conexao)):  
       ...
       echo "Conexão não encontrada, verifique sua conexão com banco de dados";  
       exit();  
     endif;   
   ...
   */  
   ...
   public function trataMensagemRetornoInsert($retorno){
      if(!$retorno){
        http_response_code(415);
        echo "Ops, falha ao inserir";
      }else{
        echo "Legal, novo cadastro inserido com sucesso";
      }
   }
   public function trataMensagemRetornoUpdate($retorno){
      if(!$retorno){
        http_response_code(415);
        echo "Ops, falha ao atualizar: ".$retorno;
      }else{
        echo "Legal, cadastro atualizado com sucesso";
      }
  }
